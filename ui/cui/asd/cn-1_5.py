...
controlnet_list = {
    ...
    "IP Adapter FaceID 1.5": [
        ...
        f"https://huggingface.co/h94/IP-Adapter-FaceID/resolve/main/ip-adapter-faceid_sd15_lora.safetensors {tmp_lora} \
    ...
    "IP Adapter FaceID Plus 1.5": [
        ...
        f"https://huggingface.co/h94/IP-Adapter-FaceID/resolve/main/ip-adapter-faceid-plus_sd15_lora.safetensors {tmp_lora} \
    ...
    "IP Adapter FaceID PlusV2 1.5": [
        ...
        f"https://huggingface.co/h94/IP-Adapter-FaceID/resolve/main/ip-adapter-faceid-plusv2_sd15_lora.safetensors {tmp_lora} \
